  ...
  void init() async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
     eProvider?.landtype =  widget.plotdetails.ST_ID == null ? null :  widget.plotdetails.ST_ID ;
      ...
      await eProvider?.culitivationApi(widget.plotdetails.CROP_ID);
      await eProvider?.vationApi(widget.plotdetails.CROP_ID);
      await eProvider?.landTypeApi(widget.plotdetails.CROP_ID);
    });
  }
